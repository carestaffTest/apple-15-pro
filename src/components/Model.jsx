...
import WebcamNavigation from "./WebcamNavigation";
import { SwitchCamera, ToggleLeft, ToggleRight } from "lucide-react";
import CheckBackCam from "./CheckBackCam";
  ...
  return (
    <section className="common-padding">
      <div className="screen-max-width">
        ...
        <div className="flex-center md:justify-start  gap-5">
          <div className="">Camera's on/off:</div>
          <div
          ...
          {power && (
            <div className="flex cursor-pointer" onClick={handleCameraSwitch}>
              <SwitchCamera />
            </div>
          )}
        </div>
